<button class='btn btn-primary' style='position:relative;right:-24%;' onclick='toggleFiltros("tamano","formato")' toggle='off' id="open-filtro-tamano-label"><strong>Filtrar por Tamaño</strong></button>
<br>
<div class='filtro-tamano-form' style='display:none;padding:10%;'>
    <div id='filtro-tamano-form'>
        <div class='container'>
            <div class='row' id='lg'>
                <div class='col-md-12'>

                    <label class='checkbox pointer' style='position:relative;left:-10%;'>
        ...
        <br>
        <div class='row'>
            <input type='button' style='position:relative;right:-25%;' class='btn btn-secondary' onclick='aplicarFiltroTamano()' value='Aplicar Filtro'>
        </div>
    </div>
</div>
