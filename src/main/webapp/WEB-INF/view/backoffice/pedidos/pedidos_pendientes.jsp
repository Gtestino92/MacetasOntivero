...
<%@include file="modal_cancelar.jsp"%>
<%@include file="modal_entregar.jsp"%>
<%@include file="modal_entregado_callback.jsp"%>
<%@include file="modal_pedido_error_callback.jsp"%>

<body style='background-color: darkseagreen;'>

<br><br><br><br><br>
<h1 style='text-decoration:underline;text-align:center'>Pedidos Pendientes</h1>
  ...
  <div class='row'>
    <div class='col-sm-8'>
    	<div id='col-listados'>
			...
			<a id="callback-btn" data-toggle="modal" href="#modal-entregado-callback" type="hidden"></a>
...
<script src='${pageContext.request.contextPath}/backoffice/js/pedidos/cancelar-pedido.js'></script>
<script src='${pageContext.request.contextPath}/backoffice/js/pedidos/entregar-pedido.js'></script>
