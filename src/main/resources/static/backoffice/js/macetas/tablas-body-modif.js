function makeListados(){
    ...
    for (j = 0; j<listadosByFormato.length; j++){
      ...
      for(i=0;i<macetas.length;i++){
        ...
        + "' id='" + cod_new + "'><i class='fa fa-camera fa-lg'></i></a> </td><td> " +
        "<a class='btn btn-primary' title='Modificar' href='" + global.context + "/backoffice/goModificarModelo?codigoNew=" + cod_new + "'>" +
        		"<i class='fa fa-edit fa-lg'></i></a> </td> <td>" +
        		"<a class='btn btn-primary btn-delete' data-toggle='modal' href='#modal-eliminar' " +
        		"title='Eliminar' cod-delete='" + cod + "' cod-new-delete='" + cod_new +  
